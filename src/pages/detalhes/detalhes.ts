...
export class DetalhesPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private toastCtrl:ToastController,
    private livroApi: LivrosApiProvider, private livrosNaoLidosProvider: LivrosNaoLidosProvider, private livrosLidosProvider: 
    LivrosLidosProvider) {
  ...
  adicionarFavorito(livro: Livro, lido: boolean) {
